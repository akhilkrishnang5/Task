...
.bg {
  background-image: url("https://dosaking.net/wp-content/uploads/2014/05/dk-header-fileminimizer.jpg");
  height: 100%;
...
<div class="bg">
<h1 class=" text-center text-light" style="padding-top: 150px" class="">Welcome All Foodies</h1>
</div>
